...
Saya akan meningkatkan pemahaman dengan: mencuba latihan mengaitkan dataset MNIST menggunakan kod PyTorch di Google Colab, membaca dokumentasi rasmi PyTorch mengenai fungsi DataLoader, serta membuat nota perbandingan ringkas antara pendekatan rule-based dan learning-based untuk projek-projek robotik.
